...
const Page = () => {
  ...
  return (
    <div>
      ...
      <div className="py-20">
        <h2 className="text-4xl uppercase font-orbitron font-black text-center">
      ...
      */}
      <div ref={sectionRef} className="relative">
        ...
        {/* CATEGORIES WRAPPER */}
        <div
          className={`flex bg-white flex-wrap justify-center gap-4 lg:gap-6 items-center px-4 mb-20 max-w-7xl mx-auto transition-all duration-300 ${
          ...
          {categories?.map((cat) => {
            ...
            return (
              <button
                ...
                } transition-colors duration-300 w-40 h-40 sm:w-44 sm:h-44 p-4 flex flex-col justify-center items-center rounded-xl shadow-md hover:shadow-lg`}
              >
                <div className="relative h-16 w-full flex items-center justify-center mb-4">
                  ...
                  <img
                    className={`${
                      cat.width
                    } absolute inset-0 m-auto transition-opacity duration-300 ease-in-out object-contain ${
        ...
        {/* PRODUCTS WRAPPER */}
        <div className="grid max-w-7xl mb-20 mx-auto gap-5 grid-cols-4 px-4">
          <ProductCard />
          <ProductCard />
          <ProductCard />
          <ProductCard />
