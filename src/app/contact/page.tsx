...
const Page = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row max-w-7xl w-full my-10 lg:my-20 mx-auto px-5 gap-10">
      
      {/* Left Column: Address and Map */}
      <div className="space-y-6 flex-1">
        <div className="text-[#333] bg-white shadow-lg p-8 rounded-xl border-t-4 border-primary">
          <h3 className="text-xl font-orbitron font-extrabold mb-4 text-primary uppercase tracking-wider">
            Address
          </h3>
          <div className="space-y-3 text-[15px]">
            <div>
              <p className="font-bold text-gray-800">Registered & Corporate Office</p>
        ...
        <div className="shadow-lg w-full h-[400px] rounded-2xl overflow-hidden border border-gray-200">
          <iframe
      ...
      <div className="flex-[1.2] bg-white shadow-2xl rounded-xl p-8 lg:p-12 border border-gray-100">
        <h3 className="text-2xl font-orbitron font-extrabold mb-8 text-[#333] uppercase tracking-tight">
        ...
        <form className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col space-y-2">
              ...
              <input
                type="text"
                placeholder="John"
                className="w-full px-4 py-3 bg-gray-50 rounded-lg border border-gray-200 focus:ring-2 focus:ring-primary focus:border-transparent focus:bg-white outline-none transition-all"
              />
            </div>
            <div className="flex flex-col space-y-2">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 bg-gray-50 rounded-lg border border-gray-200 focus:ring-2 focus:ring-primary focus:border-transparent focus:bg-white outline-none transition-all resize-none"
            ></textarea>
          </div>
